...
defined('ROLE_DISTRIBUTOR')      OR define('ROLE_DISTRIBUTOR', 2); // DISTRIBUTOR role id
defined('ROLE_EXECUTOR')      OR define('ROLE_EXECUTOR', 3); // Executor role id
...
defined('ASSETS')      OR define('ASSETS', 'optimum'); // Upload folder path
defined('IFSC_API')      OR define('IFSC_API', 'https://ifsc.datayuge.com/api/v1/'); // Upload folder path
defined('IFSC_API_KEY')      OR define('IFSC_API_KEY', 'DY-X-Authorization: 83611fdde7a0bf5e39ba0f5b4c974c6b21042432'); // Upload folder path
