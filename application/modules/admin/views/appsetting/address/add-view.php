...
<div class="container-fluid">
                ...
                <div class="card-body">
                    <div class="row">
                      <div class="col-lg-6 mb-4">
                        <h4 class="card-title">Shop Address Info
                        </h4>
                        <h5 class="card-subtitle mb-4 text-muted">address information from application.</h5>
                      </div>
                      <div class="col-lg-6 mb-4 text-right">
                        <button type="button" class="btn btn-success btn-circle" data-toggle="modal"
                        data-target="#addaddress" data-toggle="tooltip" data-placement="bottom" title="Add slider"><i class="fa fa-plus"></i> </button>
                      </div>
                        <div class="col-lg-12 ">
                                        ...
                                        <?php foreach ($contacts as $key => $value): ?>
                                          <tr>
                                            ...
                                            <td>
                                              ...
                                              data-target="#editaddress" data-toggle="tooltip" data-placement="bottom" title="Edit Matel Price"><i class="ti-pencil"></i> </button>                                            </td>
                                          </tr>
                                        <?php endforeach; ?>
                                      </form>
                                    </tbody>
    ...
    <!-- ============================================================== -->
    <!-- ============================================================== -->
    <div class="modal fade" id="addaddress" tabindex="-1" role="dialog" aria-hidden="true" style="display: none;">
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          <div class="modal-header">
              <h4 class="modal-title" id="myCenterModalLabel">Add Address Information</h4>
              <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
          </div>
          <div class="modal-body">

              <form class="pl-3 pr-3" action="<?php echo base_url('admin/appsetting/addaddressinfo') ?>" method="post">
    ...
    <div class="modal fade" id="editaddress" tabindex="-1" role="dialog" aria-hidden="true" style="display: none;">
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          <div class="modal-header">
              <h4 class="modal-title" id="myCenterModalLabel">Add Address Information</h4>
