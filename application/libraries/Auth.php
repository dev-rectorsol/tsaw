...
class Auth
{
    ...
    */
    ...
    {
        $this->CI->form_validation->set_rules('email', 'User Name', 'required');
    ...
    return $this->CI->db->get_where("logme", array("logid" => $this->user->logid))->row(0)->name;
    }
